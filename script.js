...
console.log("Bienvenio/a al bootcamp de Factoria F5");
...
let address = null;
let phoneNumber;
let hobbies = ["Music", "gym", "cooking"];
let person = { name: "Isbel", age: 29 };
